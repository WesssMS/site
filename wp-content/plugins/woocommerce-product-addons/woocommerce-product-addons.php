...
function woocommerce_product_addons_init() {
	...
	if ( ! function_exists( 'phpversion' ) || version_compare( phpversion(), '7.0.0', '<' ) ) {
		...
		$notice = sprintf( __( 'Woo Product Add-Ons requires at least PHP <strong>%1$s</strong>. Learn <a href="%2$s">how to update PHP</a>.', 'woocommerce-product-addons' ), '7.0.0', 'https://woocommerce.com/document/how-to-update-your-php-version/' );
